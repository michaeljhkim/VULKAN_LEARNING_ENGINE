...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "13.1.0"
  WORKING_DIRECTORY "/home/michael/Documents/YURRGOHT_ENGINE/build/_deps/glslang-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("13.1.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/13.1.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/michael/Documents/YURRGOHT_ENGINE/build/_deps/glslang-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/michael/Documents/YURRGOHT_ENGINE/build/_deps/glslang-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
